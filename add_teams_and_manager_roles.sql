-- Add Teams and Manager Roles Update
-- This migration adds team assignments and new manager roles for NoorCare Daily Pulse
...
-- Leave other positions without team assignments for now (Media Buyer, Warehouse Staff)
-- These can be assigned manually through the admin interface

-- Step 15: Create helper function to get team members
...
-- Final notification
SELECT 'Teams and manager roles have been successfully added to the database!' as status;
