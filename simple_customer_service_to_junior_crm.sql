-- =====================================================
-- Simple SQL Script to Update 'Customer Service' to 'Junior CRM Specialist'
-- =====================================================
...
-- 2. Update work_reports table (if position column exists)
DO $$ 
BEGIN
...
-- 3. Update monthly_shifts table (if position column exists)
DO $$ 
BEGIN
...
-- 4. Update shift_assignments table (if position column exists)
DO $$ 
BEGIN
...
-- 5. Update shifts table names (only name column, no description column)
UPDATE shifts 
SET name = REPLACE(name, 'Customer Service', 'Junior CRM Specialist')
WHERE name LIKE '%Customer Service%';

-- 6. Fix users position constraint
DO $$ 
BEGIN
