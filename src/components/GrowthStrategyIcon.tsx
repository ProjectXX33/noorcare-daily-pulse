...
interface GrowthStrategyIconProps {
  className?: string;
  size?: number;
  color?: string;
...
export const GrowthStrategyIcon: React.FC<GrowthStrategyIconProps> = ({ 
  className = "h-6 w-6", 
  size,
  color = "currentColor",
  style
...
export default GrowthStrategyIcon; 