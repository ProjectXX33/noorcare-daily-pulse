...
const ShiftsPageWrapper = () => {
  ...
  const hasAccess = ['Junior CRM Specialist', 'Senior CRM Pharmacist', 'Designer', 'Content Creator', 'Media Buyer', 'Web Developer', 'Digital Solution Manager'].includes(user?.position) || user?.role === 'admin';
